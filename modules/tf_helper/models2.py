...
from modules.pruning.pruning_utils import globally_enable_pruning
import functools
...
# modelp = resnet(3)
# modelp.load_weights(
#     "data/temp/2021.06.07/ResNet-20-repro-baseline-strange-official/id781354/rep0"
#     "/ep36.h5")
...
#     /ep36KM.h5"
# )
# for l1, l2 in zip(model.layers, modelp.layers):
#     for w1, w2 in zip(l1.weights, l2.weights):
#         if 'kernel_mask' not in w2.name:
#             w1.assign(w2)
